...
# frozen PEM
class PEM_rest(object):  # from non-stop forward in PEM
    def __init__(self, n, t, N):
        self.n = n  # dim of X
        self.t = t  # dim of Theta
        self.N = N  # total data size
    ...
    def pemR2(self, Y_sys, U, threshold1=0, threshold2=0, slot=100):
        """
