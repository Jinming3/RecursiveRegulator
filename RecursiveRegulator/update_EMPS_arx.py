...
train_time=N
update = 5  # original update,  yhat_pem add to x_step, use this, don't use 9 = 7 or 4, in dx

# update = 9  # add pem fix_alter

# update 4 and 8 only for showing
# update = 4 # stop at self.train pem in dx
